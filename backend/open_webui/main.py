...
# GovChat-NL: Voeg dit toe bij de andere app.include_router statements
...
async def get_app_config(request: Request):
    ...
    return {
        **({'onboarding': True} if onboarding else {}),
        ...
        # Customization for GovChat-NL
        'customization': {
            'empty_chat_welcome_message': config.get('customization.empty_chat_welcome_message'),
            'login_screen_subtitle': config.get('customization.login_screen_subtitle'),
            'b1_default_preserved_words': config.get('b1.default_preserved_words'),
            'enable_controls_button': config.get('customization.enable_controls_button'),
            'show_change_password': config.get('customization.show_change_password'),
            'allow_username_edit': config.get('customization.allow_username_edit'),
            'show_about_tab': config.get('customization.show_about_tab'),
            'show_overview_in_dropdown': config.get('customization.show_overview_in_dropdown'),
            'show_widescreen_mode': config.get('customization.show_widescreen_mode'),
            'show_archived_chats': config.get('customization.show_archived_chats'),
            'enable_chat_knowledge_attachment': config.get('customization.enable_chat_knowledge_attachment'),
        },
        # App Launcher for GovChat-NL
        'app_launcher': (config.get('user.permissions') or {}).get('app_launcher', {'versimpelaar': True}),
        'oauth': {
