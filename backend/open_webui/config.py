...
VERSIMPELAAR = os.environ.get('VERSIMPELAAR', 'True').lower() == 'true'
...
EMPTY_CHAT_WELCOME_MESSAGE = os.getenv('EMPTY_CHAT_WELCOME_MESSAGE', f'welkom bij {WEBUI_NAME}')

LOGIN_SCREEN_SUBTITLE = os.getenv('LOGIN_SCREEN_SUBTITLE', None)

B1_DEFAULT_PRESERVED_WORDS = os.getenv('B1_DEFAULT_PRESERVED_WORDS', json.dumps([
...
ENABLE_CONTROLS_BUTTON = os.getenv('ENABLE_CONTROLS_BUTTON', 'False').lower() == 'true'

SHOW_CHANGE_PASSWORD = os.getenv('SHOW_CHANGE_PASSWORD', 'False').lower() == 'true'

ALLOW_USERNAME_EDIT = os.getenv('ALLOW_USERNAME_EDIT', 'False').lower() == 'true'

SHOW_ABOUT_TAB = os.getenv('SHOW_ABOUT_TAB', 'False').lower() == 'true'

SHOW_OVERVIEW_IN_DROPDOWN = os.getenv('SHOW_OVERVIEW_IN_DROPDOWN', 'False').lower() == 'true'

SHOW_WIDESCREEN_MODE = os.getenv('SHOW_WIDESCREEN_MODE', 'False').lower() == 'true'

SHOW_ARCHIVED_CHATS = os.getenv('SHOW_ARCHIVED_CHATS', 'False').lower() == 'true'

ENABLE_CHAT_KNOWLEDGE_ATTACHMENT = os.getenv('ENABLE_CHAT_KNOWLEDGE_ATTACHMENT', 'False').lower() == 'true'

ENABLE_CHAT_REFERENCE_CHATS = os.getenv('ENABLE_CHAT_REFERENCE_CHATS', 'False').lower() == 'true'
...
DEFAULT_CONFIG = {
    ...
    # Personalisatie GovChat-NL (dezelfde keys als de oude PersistentConfig-entries)
    'customization.empty_chat_welcome_message': EMPTY_CHAT_WELCOME_MESSAGE,
    'customization.login_screen_subtitle': LOGIN_SCREEN_SUBTITLE,
    'b1.default_preserved_words': B1_DEFAULT_PRESERVED_WORDS,
    'customization.enable_controls_button': ENABLE_CONTROLS_BUTTON,
    'customization.show_change_password': SHOW_CHANGE_PASSWORD,
    'customization.allow_username_edit': ALLOW_USERNAME_EDIT,
    'customization.show_about_tab': SHOW_ABOUT_TAB,
    'customization.show_overview_in_dropdown': SHOW_OVERVIEW_IN_DROPDOWN,
    'customization.show_widescreen_mode': SHOW_WIDESCREEN_MODE,
    'customization.show_archived_chats': SHOW_ARCHIVED_CHATS,
    'customization.enable_chat_knowledge_attachment': ENABLE_CHAT_KNOWLEDGE_ATTACHMENT,
    'customization.enable_chat_reference_chats': ENABLE_CHAT_REFERENCE_CHATS,
